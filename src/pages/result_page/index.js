...
const ResultPage = () => {
    ...
    const { result = [] } = state || {}; // Ensure result is always an array

    const subjects = ["All", ...new Set(result.map((r) => r.question.subject))];
                    ...
                    <main className="flex-1 p-4 sm:p-6 bg-white shadow-lg rounded-lg mx-4 sm:mx-6 overflow-auto ">
                        ...
                        <div className="bg-gray-50 p-4 sm:p-6 rounded-lg shadow-md ">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                {["A", "B", "C", "D"].map((option, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            <span>
                                                {option}. {renderWithMathJax(optionValue)}
                                            </span>
                            ...
                            <div className="mt-4 p-4 bg-blue-50 border-l-4 border-blue-500 rounded-lg overflow-auto">
                                ...
                                <p>{renderWithMathJax(currentQuestion.explanation)}</p>
                            </div>
                        </div>
